...
describe InterpretService do
  ...
  describe '#list_link' do
    ...
    it "With two faqs, find title and url in response" do
  ...
  describe '#search_faq by category' do
  ...
  describe '#create_faq' do
    ...
    it "Without hashtag params, receive a error" do
      response = InterpretService.call('create_faq', {"question.original" => @question,
  ...
  describe '#create_link' do
    ...
    it "Without hashtag params, receive a error" do
      response = InterpretService.call('create_link', {"title.original" => @title,
                                                  "url.original" => @url})
      expect(response).to match("Hashtag Obrigatória")
    end
    ...
    it "With valid params, title and url in database" do
      response = InterpretService.call('create_link', {"title.original" => @title,
                                                  "url.original" => @url,
                                                  "hashtags.original" => @hashtags})
  ...
  describe '#remove_link' do
    it "With valid ID, remove_link Link" do
      link = create(:link, company: @company)
